...
import { FileText, LogOut, Languages, Settings, LayoutDashboard, Users, Activity, Server, Headset, CalendarCheck, BookOpen } from 'lucide-react';
...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: t.managerCourses?.title || 'Kursverwaltung', href: '/manager/courses', icon: BookOpen },
